...
from labs.module08 import MultiActuatorAdapter, MultiSensorAdapter, TempSensorAdapterTask, MqttClientConnector
...
class Module06Test(unittest.TestCase):
	...
	def setUp(self):
		...
		self.mqttTest = MqttClientConnector.MqttClientConnector(self.multiActuatorAdapterTest)
