...
from labs.module08 import MultiActuatorAdapter
import logging
...
class MqttClientConnector():
    ...
    actuatorTopic = "topic/actuator"
    sensorTopic   = "topic/sensor"

    #Connection States
    sensorConnected   = False
    actuatorConnected = False

    def __init__(self, actuatorAdapter: MultiActuatorAdapter.MultiActuatorAdapter):
        '''
        Constructor
        '''
